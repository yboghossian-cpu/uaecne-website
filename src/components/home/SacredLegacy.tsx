      ...
      <div className={styles.grid}>
        ...
        <div className={styles.content}>
          ...
          <p className={styles.paragraph}>
            <span className={styles.dropcap}>F</span>ounded in the historic
            heart of the Ottoman Empire and headquartered in the vibrant city
            of Beirut, the Union of the Armenian Evangelical Churches in the
            Near East has been a steadfast pillar of faith, education, and
            social service for over 180 years. Our journey is one of
            resilience and spiritual devotion, dedicated to preserving our
            rich Armenian heritage while fostering a modern Christian witness
            across borders.
          </p>
